...
<div class="hd_setup">
    ...
    <h2>
        <a href="http://www.qlyewu.com/System/setup/index.php?c=Rbac/showrole" target="_self">查看用户组(角色)</a>&nbsp;&nbsp;&nbsp;
        <br/>
        <a href="http://www.qlyewu.com/System/setup/index.php?c=Rbac" class="home">返回安装首页</a>
...
<form method="post" name="form1" id="form1" action="<?php echo U(addentrance);?>">
