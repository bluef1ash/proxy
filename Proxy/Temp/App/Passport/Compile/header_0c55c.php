...
<script type='text/javascript'>
		...
		URL = 'http://localhost/proxy/Passport/contacts/information.html';
		...
		CONTROL = 'http://localhost/proxy/index.php/Passport/Contacts';
		METH = 'http://localhost/proxy/index.php/Passport/Contacts/information';
		GROUP = 'http://localhost/proxy/./Proxy/';
		TPL = 'http://localhost/proxy/./Proxy/App/Passport/Tpl';
		CONTROLTPL = 'http://localhost/proxy/./Proxy/App/Passport/Tpl/Contacts';
