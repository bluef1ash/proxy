...
<script type='text/javascript'>
		...
		URL = 'http://localhost/proxy/Index/passport/index.html';
		...
		CONTROL = 'http://localhost/proxy/index.php/Index/Passport';
		METH = 'http://localhost/proxy/index.php/Index/Passport/index';
		GROUP = 'http://localhost/proxy/proxy/';
		TPL = 'http://localhost/proxy/proxy/App/Index/Tpl';
		CONTROLTPL = 'http://localhost/proxy/proxy/App/Index/Tpl/Passport';
...
<?php if(!defined("HDPHP_PATH"))exit;C("SHOW_NOTICE",FALSE);?>	<link href="http://localhost/proxy/proxy/App/Index/Tpl/Public/css/passport.css" rel="stylesheet" type="text/css">
</head>
<body>
	<!-- 头部开始 -->
	<div id="header">
		<ul>
			<li>
				<a title="点击查看修改个人资料" href="<?php echo U('Passport/useredit');?>"><?php echo $_SESSION['username'];?></a>
			</li>
			<li>
		...
		<img src="http://localhost/proxy/proxy/App/Index/Tpl/Public/images/mlogo.jpg" alt="个人中心">
	</div>
	<!-- 头部结束 -->
	<!-- 正文开始 -->
	<!-- 导航条开始 -->
	<div id="menu">
		<ul>
			...
			<li><a href="<?php echo U('Passport/contactus');?>">联系我们</a></li>
		</ul>
	</div>
	<!-- 导航条结束 -->
	<?php if(!defined("HDPHP_PATH"))exit;C("SHOW_NOTICE",FALSE);?>	<div id="page">
		...
		<div id="sidebar">
			<dl>
				<dt>常用功能</dt>
				<dd><a href="<?php echo U('Passport/general');?>">普通视频解析</a></dd>
				<dd><a href="<?php echo U('Passport/multi');?>">多地址解析</a></dd>
				<dd><a target="_blank" href="">偏好设置</a></dd>
				<dd><a href="<?php echo U('Passport/record');?>">解析记录</a></dd>
				<dd><a href="<?php echo U('Passport/useredit');?>">个人资料</a></dd>
				<dd><a href="<?php echo U('Passport/vip');?>">升级高级会员</a></dd>
				<!-- <dd><a href="#">我的留言</a></dd> -->
				<dt>高级会员功能</dt>
		...
		<div class="title">
			<h1>欢迎回来！</h1>
			<a href="<?php echo U('Passport/vip');?>">好消息：</a>
		</div>
		<hr>
		<!-- 头部欢迎语结束 -->
		<!-- 说明开始 -->
