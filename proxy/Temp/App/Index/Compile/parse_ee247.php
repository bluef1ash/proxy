...
<body>
	...
	<div class="header">
		...
		<!-- LOGO与采集提交按钮开始 -->
		<div class="title">
			<div class="logo"> <a href="http://localhost/proxy" title="访问首页"><img src="<?php echo U('http://localhost/proxy/proxy/App/Index/Tpl/Public/images/logo.png');?>" alt="影片采集系统"></a> </div>
